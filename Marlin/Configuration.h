...
#define STRING_CONFIG_H_AUTHOR "(Di, Tripteron)" // Who made the changes.
 ...
 *
 * Use a physical model of the hotend to control temperatu re. When configured correctly this gives
...
#define THERMAL_PROTECTION_ CHAMBER // Enable thermal protection for the heated chamber
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.073775, 79.293788, 64.564100, 102.888889 }
